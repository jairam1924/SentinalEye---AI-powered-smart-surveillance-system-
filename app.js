...
// 1. Handle file upload FIRST for /process-video
app.post('/process-video', upload.single('video'), (req, res, next) => {
  console.log('here');
  next(); // Proceed to the next middleware (which will be aiController.processVideo)
});
  ...
  try {
    ...
    const response = await axios.post(
      ...
      formData,
      {
        headers: {
          'x-rapidapi-key':
            '1f58da92b6mshabdc0ac576d42b3p125a0djsn4c4545dea176',
